...
<svelte:head>
	...
	<meta
		name="description"
		content="Some Badger Amateur Radio Society history by W6FQX"
	/>
...
<div class="mx-auto max-w-3xl pt-10 text-lg px-5 font-light">
	...
	<p class="py-4 italic font-normal">
